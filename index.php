...
<body>
    ...
    <form action="index.php" method="post" autocomplete="off">
        ...
        <h1>
           <br> Formulario a Curriculum Vitae <br>
        </h1>
        ...
        <h2>
            ...
            <div>
                ...
                <div>
                    ...
                    <select name="Pais" placeholder="Ingrese su pais" required >
        ...
        <div class="Dinamic-Container">
            ...
            <div id="Experiencia-Laboral">
                ...
                <div>
                    ...
                    <input type="text" name="cargo_ocupado[]"required/>
                </div>
                <div>
                    <span>Tipo de Empleo</span>
                    <select id="tipo-empleo" name="tipo_empleo[]"required>
                        <option value="0" selected> --Selección--</option>
            ...
            <input type="button" value="+" id = "agregar1"/>
            ...
            <input type="button" value="+" id = "agregar2"/>
            ...
            <input type="button" value="+" id = "agregar3"/>
            ...
            <input type="button" value="+" id = "agregar4"/>
